
{
  ...
  tfboost_style->SetPadTopMargin(0.14);
  tfboost_style->SetPadRightMargin(0.14);
  ...
  tfboost_style->SetTitleSize(1.0*0.054,"x");
  tfboost_style->SetTitleSize(1.0*0.054,"y");
  tfboost_style->SetTitleSize(1.0*0.054,"z");
