...
//=========  (Tue Aug 31 02:17:56 2021) by ROOT version 6.24/02
   ...
   hist_rms_noise;RMSoBVcB;Counts__13->SetBinContent(101,1000);
   hist_rms_noise;RMSoBVcB;Counts__13->SetEntries(1000);
   ...
   hist_rms_noise;RMSoBVcB;Counts__13->GetXaxis()->SetRange(1,100);
