...
//=========  (Tue Aug 31 02:17:56 2021) by ROOT version 6.24/02
   ...
   TH1D *histTOA_RM_noise__19 = new TH1D("histTOA_RM_noise__19","Time of arrival Ref.Method with noise",2000,-1,1);
   histTOA_RM_noise__19->SetBinContent(1000,22);
   histTOA_RM_noise__19->SetBinContent(1001,915);
   histTOA_RM_noise__19->SetBinContent(2001,1);
   histTOA_RM_noise__19->SetEntries(938);
   ...
   histTOA_RM_noise__19->GetXaxis()->SetRange(1,2000);
